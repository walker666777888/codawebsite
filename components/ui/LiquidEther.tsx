...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const bgC = new THREE.Color(bgColor);
    const bgVec4 = new THREE.Vector4(bgC.r, bgC.g, bgC.b, 1);
    ...
    class Simulation {
      ...
      constructor(options?: any) {
        this.options = {
          ...
          resolution: 0.5, cursor_size: 100, viscous: 30,
          isBounce: false, dt: 0.014, isViscous: false, BFECC: true, ...options
        };
