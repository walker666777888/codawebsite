  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 overflow-hidden select-none">
        ...
        <div
          className="hidden md:block absolute left-0 top-0 bottom-0 w-6 z-10 pointer-events-none"
          style={{ background: "linear-gradient(to right,#F4F0E8,transparent)" }}
        />
        {/* Right fade — desktop only */}
        <div
          className="hidden md:block absolute right-0 top-0 bottom-0 w-6 z-10 pointer-events-none"
